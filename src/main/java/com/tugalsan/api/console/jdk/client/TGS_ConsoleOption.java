...
public class TGS_ConsoleOption {
    ...
    private TGS_ConsoleOption(TGS_CharSetLocaleTypes language, TGS_Func_In2<CharSequence, List<CharSequence>> run, List<String> alias) {
        this.language = language;
        this.run = run;
        this.alias = alias;
    }
    final public TGS_CharSetLocaleTypes language;
    final public TGS_Func_In2<CharSequence, List<CharSequence>> run;
    final public List<String> alias;

    public static TGS_ConsoleOption of(TGS_CharSetLocaleTypes language, TGS_Func_In2<CharSequence, List<CharSequence>> run, List<String> alias) {
        return new TGS_ConsoleOption(language, run, alias);
    }

    public static TGS_ConsoleOption of(TGS_CharSetLocaleTypes language, TGS_Func_In2<CharSequence, List<CharSequence>> run, String... alias) {
